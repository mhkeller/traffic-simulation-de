...
var scaleInit = 1.5  // pixel/m
var scale = scaleInit
var scale_min = 0.6
var scale_max = 5

var truckFracInit = 0.15
...
var fracOffInit = 0.4 // fraction of offramp usage
...
DYN_WEB.Event.domReady(function () {
  ...
  slider_timewarp.on_move = function (x, y) { // function (x) OK
    ...
    document.getElementById('valueField_timewarp').innerHTML
           = parseFloat(get_timewarp(), 10).toFixed(1) + ' fach'
  }
}
)
...
DYN_WEB.Event.domReady(function () {
  ...
  // console.log("in slider_qIn.on_move(x,y), x="+x+" y="+y);
    ...
    document.getElementById('valueField_qIn').innerHTML
           = parseFloat(3600 * get_qIn(), 10).toFixed(0) + ' Fz/h'
  }
}
)
